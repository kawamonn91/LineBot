...
# USBカメラ設定
# ============================================================
CAMERA_INDEX = 1                # USBカメラのデバイスインデックス (BUFFALO BSWHD06M → /dev/video1)
...
# 佐川急便: 青・白ボーダーシャツ + 黒ズボン
SAGAWA_COLOR_RANGES = [
    {"lower": [90, 80, 80],   "upper": [140, 255, 255]},  # 青（シャツ）
    {"lower": [0,  0,  180],  "upper": [180, 40,  255]},  # 白（ボーダー）
]
# 分類スコア閾値（この値以上で分類確定）
